...
```{r, echo = FALSE}
pp.elements <- data.frame('element' = c("Background color", "Gridlines", "y-axis Locations", "Quantiles", "Average line", "Inference Calculation", "Inference Display"),
...
# Same as before, but with second IV on different plots by including beside = FALSE
pirateplot(formula = weight ~ Time + Diet,
           data = ChickWeight,
           theme = 2,
           beside = FALSE)
```
