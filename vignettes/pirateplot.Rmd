...
The second method is to simply enter a vector of one or more colors. Here, I'll create a black and white pirateplot from theme 2 by specifying `pal = gray(.1)`
...
Here's an example using a background color, grid lines, and quantile lines.
...
pirateplot(formula = weight ~ Time, 
           ...
           bean.b.o = 0, # Turn off bean borders
