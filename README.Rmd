...
`piratepal()` is a function that returns color palettes. See `?piratepal` or [https://cran.r-project.org/web/packages/yarrr/vignettes/piratepal.html](https://cran.r-project.org/web/packages/yarrr/vignettes/piratepal.html) for more details
...
Let's use the basel palette to draw the house from the Pixar film [Up ](https://www.youtube.com/watch?v=pkqzFUhGPJg)
